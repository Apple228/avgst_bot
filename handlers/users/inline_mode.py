    ...
    await query.answer(
        results=[
            types.InlineQueryResultArticle(
                id="unknown",
                title="Здесь старые данные пока что",
    ...
    await query.answer(
        results=[
            types.InlineQueryResultCachedDocument(
                ...
                document_file_id="BQACAgIAAxkBAAIX7mDM0WTjX1TXjLXnd6litqiIekM4AAKsDQAC-dlZSno56K-grKY5HwQ",
                description="Реквизиты Гришаткин"
            ),
            types.InlineQueryResultCachedDocument(
                id="2",
                title="Реквизиты компании",
                document_file_id="BQACAgIAAxkBAAIX8GDM0l0hdmKboGHPJcLpC7xYMnb8AAKXDAACozVYSitVc_uPBkjUHwQ",
